...
void LCD_X_Config(void) {
  ...
  //
  // pDevice = GUI_DEVICE_CreateAndLink(GUIDRV_FLEXCOLOR, GUICC_565, 0, 0); //GUIDRV_FLEXCOLOR_F66720 GUICC_M565
    pDevice = GUI_DEVICE_CreateAndLink(GUIDRV_FLEXCOLOR, GUICC_M565, 0, 0); //GUIDRV_FLEXCOLOR_F66720 GUICC_M565
  //
